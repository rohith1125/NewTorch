...
class MLP0:
    ...
    def forward(self, A0):
        ...
        A1 = self.layers[1].forward(Z0) # ReLU layer
    ...
    def backward(self, dLdA1):
        ...
        """
        dLdZ0 = self.layers[1].backward(dLdA1)  # Backprop through ReLU
        dLdA0 = self.layers[0].backward(dLdZ0)  # Backprop through Linear layer
...
class MLP1:
    ...
    def __init__(self, debug=False):
        ...
        self.layers = [Linear(2, 3), ReLU(), Linear(3, 2), ReLU()] # List of layers
        self.debug = debug
    ...
    def forward(self, A0):
        ...
        Z0 = self.layers[0].forward(A0) # Linear layer 1
        A1 = self.layers[1].forward(Z0) # ReLU layer

        Z1 = self.layers[2].forward(A1) # Linear layer 2
        A2 = self.layers[3].forward(Z1) # ReLU layer
    ...
    def backward(self, dLdA2):
        ...
        dLdZ1 = self.layers[3].backward(dLdA2) # Backprop through ReLU layer
        dLdA1 = self.layers[2].backward(dLdZ1) # Backprop through Linear layer

        dLdZ0 = self.layers[1].backward(dLdA1) # Backprop through ReLU layer
        dLdA0 = self.layers[0].backward(dLdZ0) # Backprop through Linear layer
...
class MLP4:
    def __init__(self, debug=False):
        ...
        self.layers = [Linear(2, 4), ReLU(), 
                       ...
                       Linear(8, 8), ReLU(), 
                       Linear(8, 4), ReLU(), 
                       Linear(4, 2), ReLU()] # List of layers
